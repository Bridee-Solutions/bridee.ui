...
const ConviteBody = (props) => {
    ...
    const fetchConvitesFiltered = () => {
        ...
        request.getConvitesFromCasamento(casamentoId, status.current, faixaEtaria.current, 
            categoria.current, nomeConvidado).then(response => {
            ...
            <div className={styles.body_filter}>
                <div className={styles.filter}>
                    <div className={styles.filter_input}>
                        ...
                        <FontAwesomeIcon onClick={applyFilter} icon={faMagnifyingGlass} className={styles.filter_input_icon}/>
                    </div>
                    <div className={styles.body_filter_button} onClick={() => setIsFilterOpen(!isFilterOpen)}>
                        ...
                        {isFilterOpen && 
                            <div className={styles.body_filter_options}>
                                ...
                                <div className={styles.body_filter_option}>
                                    <span>Status</span>
                                    <div className={styles.status_option} onClick={() => defineStatus("SEM_RESPOSTA")}>
                                        <div className={styles.yellow_circle}></div>
                                        <span>Sem resposta</span>
                                    </div>
                                    <div className={styles.status_option} onClick={() => defineStatus("CONFIRMADO")}>
                                        <div className={styles.green_circle}></div>
                                        <span>Irá comparecer</span>
                                    </div>
                                    <div className={styles.status_option} onClick={() => defineStatus("RECUSADO")}>
                                ...
                                <div className={styles.body_filter_option}>
                                    ...
                                    <span onClick={() => defineFaixaEtaria("ADULTO")}>Adulto</span>
                                    <span onClick={() => defineFaixaEtaria("CRIANCA")}>Criança</span>
                                </div>
                                <div className={styles.body_filter_option}>
                                    <span>Categorias</span>
                                    <span onClick={() => defineCategory("AMIGOS")}>Amigos</span>
                                    <span onClick={() => defineCategory("COLEGAS_DE_TRABALHO")}>Colegas de trabalho</span>
                                    <span onClick={() => defineCategory("FAMILIA_DA_NOIVA")}>Familia da noiva</span>
                                    <span onClick={() => defineCategory("FAMILIA_DO_NOIVO")}>Familia do noivo</span>
                                </div>
                            </div>
                        }
                    </div>
