          ...
          <div className={styles.secoesConfiguracoes}>
            ...
            <div className={styles.card}>
              ...
              <div className={styles.cardHeader}>
                <span className={styles.tituloCard}>Detalhes do casamento</span>
              ...
              <div className={styles.containerText}>             
                ...
                <div className={styles.detailRow}>
                  <span className={styles.label}>Contagem de convidados</span>
                  <span className={styles.value}>Adicionar</span>
                </div>
                <div className={styles.detailRow}>
            ...
            <div className={styles.card}>
              ...
              <div className={styles.cardContent}>
                <div className={styles.detailRow}>
                  ...
                  <span className={styles.value}>amandasbapt@outlook.com</span>
                </div>
                <div className={styles.detailRow}>
