  ...
  return (
    <div className={styles.convites_page}>
      ...
      <div className={styles.convites_content}>
        <div className={breadcumbs.tituloPage}>
          <p>
            Painel {">"} Ferramentas de planejamento {">"}{" "}
            <b>Lista de convidados</b>
          </p>
        </div>
        <div className={styles.convites_container}>
          <div className={styles.convites_container_left}>
            <div
              className={styles.convites_container_left_header}
              onClick={() => relatorioModal(closeModal, setActualModal)}
            >
              <div className={styles.relatorio_circle_div}>
                <div className={styles.relatorio_circle_div_content}>
                  ...
                  <div className={styles.alinharbolas}>
                    <div className={styles.green_circle}></div>
                    <div className={styles.yellow_circle}></div>
                    <div className={styles.red_circle}></div>
                  </div>
                </div>
                <span className={styles.comparecer}>
                  {confirmados ? confirmados : 0} convidados irão comparecer
                </span>
              </div>
              <img src={rightArrow} />
            </div>
            <div className={styles.convites_container_left_body}>
              <div
                className={styles.convites_container_left_body_item}
                onClick={() => whatsappMessageModal(closeModal, setActualModal)}
              >
                <FontAwesomeIcon icon={faWhatsapp} className={styles.iconC} />
              ...
              >
                <FontAwesomeIcon icon={faGear} className={styles.iconC}  />
                <p>Gerenciar confirmações</p>
              </div>
              <div className={styles.convites_container_left_body_item}>
                <FontAwesomeIcon icon={faChair} className={styles.iconC}  />
            ...
            <div className={styles.convites_container_left_footer}>
              ...
              <FontAwesomeIcon
                ...
                icon={faCopy}
                className={styles.convites_container_left_footer_icon}
              />
            </div>
          </div>
